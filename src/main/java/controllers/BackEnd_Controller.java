...
public class BackEnd_Controller extends Base_Controller {
    ...
    private boolean action_crudStagione(HttpServletRequest request, HttpServletResponse response) {
    ...
    public void create_Img(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
